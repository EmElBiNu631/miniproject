...
import '../wigets/tasklist.dart';
import 'faceregocationview.dart';
...
class Profilepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: existingVm, // reuse existing instance
...
class ProfileContent extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  OverviewCard(
                      value: profileVm.presence.toString(),
                      label: "Presence",
                      color: Colors.green),
                  OverviewCard(
                      value: profileVm.absence.toString(),
                      label: "Absence",
                      color: Colors.red),
                  OverviewCard(
                      value: profileVm.leaves.toString(),
                      label: "Leaves",
                      color: Colors.orange),
                ],
              ),
               SizedBox(height: 20),
               Text("Performance Task List",
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
               SizedBox(height: 8),
              ...
              _buildFilterChips(),
               SizedBox(height: 16),
              TaskList(tabIndex: profileVm.selectedTabIndex),
               SizedBox(height: 20),
               Text("Dashboard",
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
               SizedBox(height: 8),
  ...
  Widget _buildHeader() {
    return Row(
      children:  [
        CircleAvatar(
            radius: 24, backgroundImage: AssetImage("assets/images/profile.jpg")),
        SizedBox(width: 10),
         ...
         children: [
           ...
           Row(
             children: [
               Icon(
                 Icons.access_time,
                 color: vm.isCheckedIn ? Colors.redAccent : Colors.green,
               ),
               Expanded(
    ...
    return Row(
      children: [
        ...
        FilterChip(
          ...
          label:  Text("Deadline", style: TextStyle(color: Colors.redAccent)),
          onSelected: (_) {},
        ),
         SizedBox(width: 8),
        FilterChip(
          backgroundColor: Colors.grey.shade200,
          label:  Text("Project", style: TextStyle(color: Colors.greenAccent)),
          onSelected: (_) {},
        ),
         Spacer(),
  ...
  Widget _buildDashboardGrid() {
    return GridView.count(
      ...
      children:  [
        DashboardItem(icon: Icons.calendar_today, title: "Attendance"),
        DashboardItem(icon: Icons.logout, title: "Leaves"),
        DashboardItem(icon: Icons.info, title: "Leave Status"),
        DashboardItem(icon: Icons.event_note, title: "Holiday List"),
        DashboardItem(icon: Icons.receipt_long, title: "Payslip"),
        DashboardItem(icon: Icons.bar_chart, title: "Reports"),
      ],
    );
  }
}
